...
byte mac[] = {0x5C, 0xC9, 0xD3, 0x3F, 0xBF, 0x86}; //physical mac address //E0-CB-4E-20-9D-15 //0x90, 0xA2, 0xDA, 0x0F, 0x09, 0xA7
byte ip[] = { 192, 168, 1, 181 }; // ip in lan
    ...
    while (client.connected()) {
      if (client.available()) {
        ...
        if (c == '\n') {
          ...
          client.println("<script type='text/javascript' src='http://yourjavascript.com/91171215069/remoteautomationv1-0.js'></script>");
          client.println("</head>");
          client.println("<body>");
