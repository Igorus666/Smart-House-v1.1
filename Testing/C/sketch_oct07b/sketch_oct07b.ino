// 192, 168, 88, 119 - F8-A9-63-5C-DF-55 - 0xA2, 0xDA, 0x0F, 0x09, 0xA7
    ...
    while (client.connected()) {
      if (client.available()) {
        ...
        if (c == '\n') {
          ...
          client.println("<link rel='stylesheet' type='text/css' href='https://raw.githubusercontent.com/Igorus666/Smart-House-v1.1/master/Testing/CSS/Testing-RemoteAutomationV1.0.css' />");
          client.println("<script type='text/javascript' src='https://raw.githubusercontent.com/Igorus666/Smart-House-v1.1/master/Testing/Javascript/Testing-RemoteAutomationV1.0.js'></script>");
          client.println("</head>");
          client.println("<body>");
